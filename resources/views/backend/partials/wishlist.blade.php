<div class="wish-list-wrap">
    ...
    <div class="wish-list-container">
        ...
        <div class="wish-list-item fl-wrap">
            <div class="wish-list-img"><a href="listing-single.html"><img src="{{asset('frontend/images/all/thumbnails/1.jpg')}}" alt=""></a>
            </div>
            <div class="wish-list-descr">
                ...
                <div class="clear-wishlist tolt"  data-microtip-position="left"  data-tooltip="Remove Item" ><i class="fa-regular fa-trash-can"></i></div>
            </div>
        </div>
        <!--wish-list-item end-->
        <!--wish-list-item-->
        <div class="wish-list-item fl-wrap">
            ...
            <div class="wish-list-descr">
                ...
                <div class="geodir-category-location fl-wrap"><a href="#">    34-42 Montgomery St , NY, USA</a></div>
